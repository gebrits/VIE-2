...
new VIE2.Mapping(
    ...
    ['foaf:Person', 'dbonto:Person', 'oc:Person'],  //a list of all types that fall into this category
    ['rdfs:label', 'foaf:name', 'ocpred:name', 'foaf:page', 'foaf:depiction'], //a list of default properties
    {// optional options
